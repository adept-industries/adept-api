...
public class RiskPrediction extends BaseEntity {
    ...
    private PullRequestFeature feature;
    ...
    @Column(name = "risk_score", nullable = false, precision = 7, scale = 6)
